//package com.example.javafeatures.Repositry.RecordImpl;
//
...
//import com.example.javafeatures.Record.Record;
...
//    }
//
//    public CustomerRecord SetLoadFields(CustomerFields customerFields) throws NoSuchFieldException {
//        Field field = Customer.class.getDeclaredField(customerFields.name());
//
...
//    public CustomerRecord SetLoadFields(CustomerFields... customerFields) throws NoSuchFieldException {
//
//        for (CustomerFields customerField : customerFields) {
//            Field finalField = Customer.class.getDeclaredField(customerField.name());
//
